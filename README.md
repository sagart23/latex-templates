...
Custom .sty packages and formatting tools
...
🎨 Custom style files (.sty) for boxes, highlights & math environments

📂 Fully structured folders for easy navigation

🔧 Compatible with TeX Live, MiKTeX, Overleaf, and VS Code + LaTeX Workshop
🛠️ How to Use
...
for educators who value clean, beautiful, structured LaTeX documents.
